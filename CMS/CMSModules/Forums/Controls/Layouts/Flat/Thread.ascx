                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr style="border: medium none;">
                                                                    <td style="border: medium none; padding-right: 5px; vertical-align: top;" class="UserAvatar">
                                                                        ...
                                                                        <%--Send message--%>
                                                                        <%#IFCompare((EnableMessaging) && (ValidationHelper.GetInteger(Eval("PostUserID"), 0) > 0), "<div class=\"PostExtendedActions\">", "")%>
                                                                        ...
                                                                        <%#IFCompare((EnableMessaging) && (ValidationHelper.GetInteger(Eval("PostUserID"), 0) > 0), "</div>", "")%>
                                                                    </td>

...
{{
    ...
    private void SetupTextBoxButtons()
    {
        ...
        {
            btnClear.OnClientClick = GetCleanButtonScript(control);
        }
...
";
    ...
    private string GetCleanButtonScript(Control inputControl)
    {
        return $"US_SetVal('{GetClientID(inputControl)}', ''); return false;";
    }
